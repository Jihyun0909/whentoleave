...
/**
 * 좌표 -> 인천 BIMS 정류소 ID 매칭을 캐싱한다. TagoBusStopCacheService와 같은 lazy cache-aside 방식.
 */
@Service
public class IncheonBusStopCacheService implements IncheonBusStopLookup {

    private static final String PROVIDER = "INCHEON";

    private final RegionalBusStopMappingRepository repository;
    private final IncheonStationFinder stationFinder;

    public IncheonBusStopCacheService(RegionalBusStopMappingRepository repository,
                                       IncheonStationFinder stationFinder) {
